...
// Data struct which holds interesting info from the tweet payload
type Data struct {
	Tweets []struct {
...
// ParseTweetData pull relevant parts out of the large JSON object sent by twitter
func ParseTweetData(body []byte) (ProcessedData, error) {
